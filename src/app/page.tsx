  ...
  <div className="container mx-auto px-4 sm:px-6 md:px-12 lg:px-24 xl:px-32 relative z-10">
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
      ...
      <div className="flex flex-col items-start mt-6 md:mt-0">
        ...
        <h2 className="headr text-[#000000] inter800 text-3xl sm:text-[15px] md:text-[50px] lg:text-[65px] mb-3">Der Partner<br /><span className="bg-gradient-to-r from-[#14532d] to-[#16a34a] bg-clip-text text-transparent">im D2D in Bayern</span></h2>
