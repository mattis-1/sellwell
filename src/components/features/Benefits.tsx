...
<div className="flex flex-col sm:flex-row gap-4 justify-center items-center w-full pt-12">
      <Link href="/karriere">
      <button className="sellwell-btn-primary sm:w-auto w-full">
        Jetzt schnell bewerben
      </button>
      </Link>
      <Link href="#team">
      <button className="sellwell-btn-secondary flex items-center justify-center space-x-2 sm:w-auto w-full">
