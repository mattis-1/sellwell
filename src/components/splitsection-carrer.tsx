...
">KARRIEREMÖGLICHKEITEN</span>
            <h2 className="headr mb-5"><span className="bg-gradient-to-r from-[#0C462B] to-[#057741] bg-clip-text text-transparent
">Warum</span> bei<br />Sellwell arbeiten?</h2>
        ...
        <div className="w-full md:w-1/2 min-h-[300px] md:min-h-full relative">
          ...
          <div className="absolute inset-0 bg-gray-300">
            {/* Platzhalter-Text (entfernen, wenn echtes Bild vorhanden) */}
            <div className="absolute inset-0 flex items-center justify-center">
              <p className="text-gray-600 font-medium">Bild hier</p>
            </div>
            
            {/* Auskommentiert bis echtes Bild vorhanden */}
