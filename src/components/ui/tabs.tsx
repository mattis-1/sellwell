...
<div className="lg:w-3/5 text-black flex flex-col justify-start pr-0 md:pr-4 text-left lg:pr-30">
  ...
  <div className="flex justify-start w-full">
    <button onClick={openFirmaModal} className="px-4 sm:px-5 md:px-6 py-2 sm:py-3 text-sm sm:text-base text-white font-semibold rounded-full transition-all bg-gradient-to-r from-[#0B3E27] to-[#047A43] shadow-[0_2px_8px_-2px_rgba(4,122,67,0.5)] hover:shadow-[0_4px_12px_-2px_rgba(4,122,67,0.7)]">
      {activeTab.buttonText}
    </button>
  </div>
)}
